...
import com.greathealth.greathealth.common.annotation.Log;
...
import com.greathealth.greathealth.common.enums.BusinessType;
import com.greathealth.greathealth.common.utils.file.FileUploadUtils;
import com.greathealth.greathealth.common.utils.file.MimeTypeUtils;
...
public class SysProfileController extends BaseController {
    ...
    public AjaxResult avatar(@RequestParam("avatarfile") MultipartFile file) throws Exception {
        if (!file.isEmpty()) {
            LoginUser loginUser = getLoginUser();
            String avatar = FileUploadUtils.upload(GreathealthConfig.getAvatarPath(), file, MimeTypeUtils.IMAGE_EXTENSION);
