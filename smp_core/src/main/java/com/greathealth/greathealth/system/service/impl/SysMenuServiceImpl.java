...
import com.greathealth.greathealth.system.domain.vo.MetaVo;
import com.greathealth.greathealth.system.domain.vo.RouterVo;
import com.greathealth.greathealth.system.mapper.SysMenuMapper;
...
import com.greathealth.greathealth.common.core.domain.TreeSelect;
...
public class SysMenuServiceImpl implements ISysMenuService {
    ...
    @Override
    public List<SysMenu> selectMenuTreeByNurseUserId(String userId) {
        List<SysMenu> menus = null;
        if (SecurityUtils.isAdmin(userId)) {
            menus = menuMapper.selectMenuTreeAll();
        } else {
            menus = menuMapper.selectMenuTreeByNurseUserId(userId);
        }
        return getChildPerms(menus, "0");
    }
