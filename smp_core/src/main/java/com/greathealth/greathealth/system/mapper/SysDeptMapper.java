package com.greathealth.greathealth.system.mapper;
...
public interface SysDeptMapper {
     ...
     * @return 选中部门列表
     */
    public List<Long> selectDeptListByRoleId(@Param("roleId") String roleId, @Param("deptCheckStrictly") boolean deptCheckStrictly);
    ...
    Optional<SysDeptVo> selectById(String deptId);
    ...
    List<SysDept> selectChildrenDeptByParentId(String deptId);

    List<SysDept> selectChildDepartmentByParentId(String deptId);
